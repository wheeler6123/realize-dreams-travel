            ...
            <div className="flex">
                {sliderData?.map((item) => {
                    ...
                    <div className="embla__slide relative h-full w-full" key={item.id}>
                        ...
                        {/* title/subtitle */}
                        <h1 className="absolute top-1 left-1/4 w-full md:w-auto transform -translate-x-1/2 translate-y-[3rem] md:translate-y-[9rem]  lg:translate-y-48  py-2 lg:py-4 px-2 lg:px-8 text-4xl lg:text-6xl text-white font-extrabold">
                        {item.title}
                        </h1>
                    </div>
                    );

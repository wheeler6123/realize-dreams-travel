...
export default function Carousel() {
    ...
    return (
        <div
            className="overflow-hidden bg-gray-200 w-full mx-auto flex items-center justify-center h-auto lg:h-screen"
            ref={emblaRef}
        >
            <div className="flex">
                {sliderData?.map((item) => {
                    ...
                    <div className="embla__slide relative h-full w-full" key={item.id}>
                        ...
                        {/* the image */}
                        <Image className="w-full h-full" src={item.src} alt="" />

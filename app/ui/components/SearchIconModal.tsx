...
export default function SearchIconModal() {
    ...
    return (
        ...
        <Button 
            as='span'
            id='search-icon'
            className='hidden md:flex bg-transparent focus:outline-none items-center border-none !p-0 !m-0 h-20 w-20 cursor-pointer'
